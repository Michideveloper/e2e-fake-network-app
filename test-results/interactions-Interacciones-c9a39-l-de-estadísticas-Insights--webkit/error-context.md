...
- main:
  ...
  - text: 9111 Me gusta influencer_fake¡Bienvenidos a Waifu.ai! Este es un post viral simulado. Deja pasar unos minutos y verás un crecimiento exponencial de engagement. 🚀🔥
  ...
  - button "bar-chart Ver estadísticas de engagement":
    - img "bar-chart"
    - text: Ver estadísticas de engagement
  - text: "0 Me gusta okiqIlustración creada por @okiq. Generada de manera infinita mediante API y simulada en local. 🌸🎌 #AnimeArt"
  - textbox "Añade un comentario..."
  - button "Publicar" [disabled]
  - text: タ タイサカ Hace 2 min
  - img "global"
  - text: Inactivo
  - button "delete":
    - img "delete"
  ...
  - button "bar-chart Ver estadísticas de engagement":
    - img "bar-chart"
    - text: Ver estadísticas de engagement
  - text: "0 Me gusta タイサカIlustración creada por @タイサカ. Generada de manera infinita mediante API y simulada en local. 🌸🎌 #AnimeArt"
  - textbox "Añade un comentario..."
  - button "Publicar" [disabled]
  - text: R Rin Hace 3 min
  - img "fire"
  - text: Viral
  - button "delete":
    - img "delete"
  ...
  - button "bar-chart Ver estadísticas de engagement":
    - img "bar-chart"
    - text: Ver estadísticas de engagement
  - text: "0 Me gusta RinIlustración creada por @Rin. Generada de manera infinita mediante API y simulada en local. 🌸🎌 #AnimeArt"
  - textbox "Añade un comentario..."
  - button "Publicar" [disabled]
  - text: 時 時雨ひまり Hace 4 min
  - img "coffee"
  - text: Normal
  - button "delete":
    - img "delete"
  ...
  - button "bar-chart Ver estadísticas de engagement":
    - img "bar-chart"
    - text: Ver estadísticas de engagement
  - text: "0 Me gusta 時雨ひまりIlustración creada por @時雨ひまり. Generada de manera infinita mediante API y simulada en local. 🌸🎌 #AnimeArt"
  - textbox "Añade un comentario..."
  - button "Publicar" [disabled]
  - text: M Mogu Zaemon Hace 5 min
  - img "fire"
  - text: Viral
  - button "delete":
    - img "delete"
  ...
  - button "bar-chart Ver estadísticas de engagement":
    - img "bar-chart"
    - text: Ver estadísticas de engagement
  - text: "0 Me gusta Mogu ZaemonIlustración creada por @Mogu Zaemon. Generada de manera infinita mediante API y simulada en local. 🌸🎌 #AnimeArt"
  - textbox "Añade un comentario..."
  - button "Publicar" [disabled]
  - complementary:
    - img "user"
