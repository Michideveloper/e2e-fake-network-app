...
- main:
  ...
  - button "bar-chart Ver estadísticas de engagement":
    - img "bar-chart"
    - text: Ver estadísticas de engagement
  - text: "0 Me gusta ももしきIlustración creada por @ももしき. Generada de manera infinita mediante API y simulada en local. 🌸🎌 #AnimeArt"
  - textbox "Añade un comentario..."
  - button "Publicar" [disabled]
  - text: ぼ ぼの Hace 2 min
  - img "coffee"
  - text: Normal
  - button "delete":
    - img "delete"
  ...
  - button "bar-chart Ver estadísticas de engagement":
    - img "bar-chart"
    - text: Ver estadísticas de engagement
  - text: "0 Me gusta ぼのIlustración creada por @ぼの. Generada de manera infinita mediante API y simulada en local. 🌸🎌 #AnimeArt"
  - textbox "Añade un comentario..."
  - button "Publicar" [disabled]
  - text: ひ ひなた Hace 3 min
  - img "global"
  - text: Inactivo
  - button "delete":
    - img "delete"
  ...
  - button "bar-chart Ver estadísticas de engagement":
    - img "bar-chart"
    - text: Ver estadísticas de engagement
  - text: "0 Me gusta ひなたIlustración creada por @ひなた. Generada de manera infinita mediante API y simulada en local. 🌸🎌 #AnimeArt"
  - textbox "Añade un comentario..."
  - button "Publicar" [disabled]
  - text: フ フェルティア Hace 4 min
  - img "global"
  - text: Inactivo
  - button "delete":
    - img "delete"
  ...
  - button "bar-chart Ver estadísticas de engagement":
    - img "bar-chart"
    - text: Ver estadísticas de engagement
  - text: "0 Me gusta フェルティアIlustración creada por @フェルティア. Generada de manera infinita mediante API y simulada en local. 🌸🎌 #AnimeArt"
  - textbox "Añade un comentario..."
  - button "Publicar" [disabled]
  - text: H hitsukuya Hace 5 min
  - img "fire"
  - text: Viral
  - button "delete":
    - img "delete"
  ...
  - button "bar-chart Ver estadísticas de engagement":
    - img "bar-chart"
    - text: Ver estadísticas de engagement
  - text: "0 Me gusta hitsukuyaIlustración creada por @hitsukuya. Generada de manera infinita mediante API y simulada en local. 🌸🎌 #AnimeArt"
  - textbox "Añade un comentario..."
  - button "Publicar" [disabled]
  - complementary:
    - img "user"
