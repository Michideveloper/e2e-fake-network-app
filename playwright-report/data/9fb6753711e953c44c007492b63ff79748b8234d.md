...
- complementary:
  ...
  - text: Perfil
- main:
  - text: "[ ESTADÍSTICAS_RED_GRID ] 44 EN LÍNEA SITIO: Waifu.ai CREADOR: qa.michi"
  ...
  - button "bar-chart Ver estadísticas de engagement":
    - img "bar-chart"
    - text: Ver estadísticas de engagement
  - text: "0 Me gusta ろじうらおIlustración creada por @ろじうらお. Generada de manera infinita mediante API y simulada en local. 🌸🎌 #AnimeArt"
  - textbox "Añade un comentario..."
  - button "Publicar" [disabled]
  - text: 黒 黒澤チョコ Hace 2 min
  - img "global"
  - text: Inactivo
  - button "delete":
    - img "delete"
  ...
  - button "bar-chart Ver estadísticas de engagement":
    - img "bar-chart"
    - text: Ver estadísticas de engagement
  - text: "0 Me gusta 黒澤チョコIlustración creada por @黒澤チョコ. Generada de manera infinita mediante API y simulada en local. 🌸🎌 #AnimeArt"
  - textbox "Añade un comentario..."
  - button "Publicar" [disabled]
  - text: さ さくらねこ Hace 3 min
  - img "fire"
  - text: Viral
  - button "delete":
    - img "delete"
  ...
  - button "bar-chart Ver estadísticas de engagement":
    - img "bar-chart"
    - text: Ver estadísticas de engagement
  - text: "0 Me gusta さくらねこIlustración creada por @さくらねこ. Generada de manera infinita mediante API y simulada en local. 🌸🎌 #AnimeArt"
  - textbox "Añade un comentario..."
  - button "Publicar" [disabled]
  - text: し しばくま Hace 4 min
  - img "global"
  - text: Inactivo
  - button "delete":
    - img "delete"
  ...
  - button "bar-chart Ver estadísticas de engagement":
    - img "bar-chart"
    - text: Ver estadísticas de engagement
  - text: "0 Me gusta しばくまIlustración creada por @しばくま. Generada de manera infinita mediante API y simulada en local. 🌸🎌 #AnimeArt"
  - textbox "Añade un comentario..."
  - button "Publicar" [disabled]
  - text: L Lyon（金城和宏） Hace 5 min
  - img "fire"
  - text: Viral
  - button "delete":
    - img "delete"
  ...
  - button "bar-chart Ver estadísticas de engagement":
    - img "bar-chart"
    - text: Ver estadísticas de engagement
  - text: "0 Me gusta Lyon（金城和宏）Ilustración creada por @Lyon（金城和宏）. Generada de manera infinita mediante API y simulada en local. 🌸🎌 #AnimeArt"
  - textbox "Añade un comentario..."
  - button "Publicar" [disabled]
  - complementary:
    - img "user"
